...
$(MEM_0)_END := 0x0f00ffff
$(MEM_0)_SPAN := 0x00010000
$(MEM_0)_HIERARCHICAL_PATH := bootmem
$(MEM_0)_WIDTH := 32
...
.PHONY: bootmem
bootmem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(MEM_1)_START := 0x10800000
$(MEM_1)_END := 0x10ffffff
$(MEM_1)_SPAN := 0x00800000
$(MEM_1)_HIERARCHICAL_PATH := epcq
$(MEM_1)_WIDTH := 32
...
.PHONY: epcq
epcq: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex
