/**************************************************************************
	MMC/SDカードSPIアクセスペリフェラル
		デバイスサポート関数 (Cineraria DE0-CV version)
...
// ******************************************************************* //
//  COPYRIGHT (C) 2011,2015 J-7SYSTEM WORKS LTD. ALL RIGHTS RESERVED.  //
//                                                                     //
...
#define mmc_clock_freq          (50000000)
...
#define mmc_ddmode_freq			(25 * 1000 * 1000)	// DDmode = 25MHz 
