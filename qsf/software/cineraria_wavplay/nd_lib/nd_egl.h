...
//#define IORD(_base,_num)		( *(volatile alt_u32 *)(((_base)+(_num)*4)|0x80000000ul) )
//#define IOWR(_base,_num,_data)	( *(volatile alt_u32 *)(((_base)+(_num)*4)|0x80000000ul) = (alt_u32)(_data) )
